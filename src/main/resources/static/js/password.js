    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data == "ok") {
                ...
                document.getElementById('join-exec-btn').classList.remove('btn-disabled');
...
function passwordValidator() {
    let passwordVal = $('#changePassword').val();
    ...
    if (regex.test(passwordVal)) {
        ...
        if ($('#password-msg').length > 0) {
            $('#password-msg').hide();
            document.getElementById('changePassword').classList.remove('field-input-error');
        } else {
        ...
        document.getElementById('changePassword').classList.add('field-input-error');
    }
}
...
function passwordCheckValidator() {
    let passwordVal = $('#changePassword').val();
    let passwordCheckVal = $('#changePasswordCheck').val();
    ...
    if (passwordVal == passwordCheckVal) {
        ...
        document.getElementById('changePasswordCheck').classList.remove('field-input-error');
        ...
        document.getElementById('changePasswordCheck').classList.add('field-input-error');
    }
}
